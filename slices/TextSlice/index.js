...
const TextSlice = ({ slice }) => {
  return (
    ...
    >
      <div className={`py-24 gap-16 inline-flex flex-col items-center w-screen bg-greenGrey ${slice.primary.text_align || 'text-center'} ${slice.primary.background_color ? backgroundColor[slice.primary.background_color] : backgroundColor.Grey}`}>
